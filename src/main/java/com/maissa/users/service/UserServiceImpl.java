...
import com.maissa.users.service.exceptions.EmailAlreadyExistsException;
import com.maissa.users.service.exceptions.ExpiredTokenException;
import com.maissa.users.service.exceptions.InvalidTokenException;
import com.maissa.users.service.register.RegistationRequest;
import com.maissa.users.service.register.VerificationToken;
import com.maissa.users.service.register.VerificationTokenRepository;
import com.maissa.users.util.EmailSender;
...
public class UserServiceImpl implements UserService {
	...
	public void sendEmailUser(User u, String code) {
		 String emailBody ="Good morning "+ "<h1>"+u.getUsername() +"</h1>" +
